 ...
 */
public class DTWwithZnorm extends ProcessWindowFunction<KeyedDataPoint<Double>, Tuple5<Long, Long, Double, String, Long>, Tuple, TimeWindow> {
    ...
    public DTWwithZnorm(List<KeyedDataPoint<Double>> pattern, String searchTyp, double relWarpingWindow, double maxDistance, double maxEuDistance, boolean art, double distanceMarginBound) {
