...
public class SampledDataSeveralSourceFunction implements SourceFunction<KeyedDataPoint<Double>> {
    ...
    private Logger LOG = LoggerFactory.getLogger(SampledDataSeveralSourceFunction.class);

    public SampledDataSeveralSourceFunction(String keyValue, String fileName, long samplingRate) {
        this.key = keyValue;
